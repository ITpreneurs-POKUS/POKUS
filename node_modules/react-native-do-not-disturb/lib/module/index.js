...
const LINKING_ERROR = `The package 'react-native-do-not-disturb' doesn't seem to be linked. Make sure: \n\n` + Platform.select({
...
export function isDoNotDisturbModeOn() {
...
export function openDoNotDisturbSettings() {
  if (Platform.OS === 'android') {
