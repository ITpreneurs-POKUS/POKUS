...
function AuthStack() {
    ...
    return (
      <AuthStack.Navigator screenOptions={{ headerShown: false, statusBarColor: '#050A30' }}>
  ...
  function HomeDrawer() {
    ...
    return (
      <HomeDrawer.Navigator
        ...
        <HomeDrawer.Screen name='HomeStack' component={HomeStack} options={{gestureEnabled: false}}/>
      </HomeDrawer.Navigator>
    );
  }
    ...
    return (
      ...
      >
        ...
        <Tab.Screen
          ...
          component={SearchTab}
          options={{
            tabBarIcon: ({ color }) => <Icon name="magnify" size={30} color={color} />,
          }}
        />
        <Tab.Screen
          name='AddTab'
        ...
        <Tab.Screen
          ...
          component={TimerTab}
          options={{
            tabBarIcon: ({ color }) => <Icon name="clock" size={30} color={color} />,
          }}
        />
        <Tab.Screen
          name='DNDTab'
          component={DNDTab}
          options={{
            tabBarIcon: ({ color }) => <Icon name="moon-waxing-crescent" size={30} color={color} />,
          }}
        />
      </Tab.Navigator>
    );
